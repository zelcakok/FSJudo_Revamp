...
class Contact extends Component {
  ...
  render(){
    return(
      <div style={{padding:"10px"}}>
        <Card style={{maxWidth:"1000px", float:"none", margin:"auto"}}>
          <CardHeader title="查詢 / 報名" subheader="Inquiry / Application"/>
          <CardContent>
            <Button variant="extendedFab"
                    ...
                    onClick={this.phone}>
                <PhoneIcon />
              <ListItemText className="displayName" primary="Tel:&nbsp;&nbsp;&nbsp;9267 4030"/>
            </Button>
            ...
            <Button variant="extendedFab"
                    ...
                    onClick={this.email}>
                <EmailIcon />
              <ListItemText className="displayName" primary="Email: info@fsjud.com"/>
            </Button>
          </CardContent>
        </Card>
      </div>
